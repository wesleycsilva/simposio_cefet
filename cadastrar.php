...
<?php require_once 'menu_cadastrar.php' ?>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <p>Para realizar sua inscrição, por favor, cadastre-se. <br>Após o cadastro é necessário acessar a
                            área do simposista através de login (e-mail e senha). <br><strong>Realizar sua inscrição nas palestras
                                e/ou visitas técnicas desejadas</strong>.</p>
                    </div>
                </div>
                <div class="form">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="controleRadios" id="alunosCefet"
                                           value="1">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="controleRadios"
                                           id="publicoExterno" value="2">
                                ...
                                <div class="form-group all">
                                    <input type="email" class="form-control" name="emailConfirmacao"
                                           id="emailConfirmacao"
    ...
    <div class="modal fade" id="modalCadastroErro" tabindex="-1" role="dialog" aria-labelledby="modalCadastroErroLabel"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
