...
class Simposista extends Conexao
{
    private $pdo;
    public $msgErro = "";
    public $id;
    ...
    public function logar($email, $senha) {
      ...
      $query = "SELECT idSimposista FROM simposista WHERE email = :e AND senha = :s ";
      $conexao = Conexao::pegarConexao();
      $stmt = $conexao->prepare($query);
      ...
      if ($stmt->rowCount() > 0) {
        ...
        $dado = $stmt->fetch();            
        // session_start();
        // $_SESSION['idSimposista'] = $dado['idSimposista'];
        // echo "sucesso";         
    ...
    public function setDataNascimento($dataNascimento){ $this->dataNascimento = $dataNascimento; return $this; }
    ...
    public function setSenha($senha){ $this->senha = md5($senha); return $this;}
